...
Config.PimpGuy = {
	{ model = "s_m_m_bouncer_01", coords = vector4(135.8, -1279.16, 28.37, 298.63),}, -- vanilla
	{ model = "s_m_m_bouncer_01", coords = vector4(-1401.58, -594.91, 29.38, 32.23),}, -- bahamas
	{ model = "s_m_m_bouncer_01", coords = vector4(315.69, -219.83, 53.22, 338.07),} -- motels
}
